...
{
    public interface IKamoRepository<TEntity, TPrimaryKey> : IKamoRepository where TEntity : IEntity, IEntity<TPrimaryKey>
    {
        #region query
        ...
        T Query<T>(Expression<Func<TEntity, bool>> queryMethod);
